...
rda_total_plot <- ggplot() +
  ...
  labs(title = "Total Emergence", 
       x= "RDA1* (7% total variance)",
       y="RDA2 (4% total variance)")
```
...
rda_ple_plot <- ggplot() +
  ...
  labs(title = "Stoneflies (Plecoptera)", 
       x="RDA1 (14% total variance)",
       y="RDA2 (8% total variance)") +
  xlim(c(-2,2))
```
...
sfa_position_S_plot <- ggplot() +
  ...
  geom_vline(aes(xintercept = 137), linetype = "dashed") +
  geom_vline(aes(xintercept = 211), linetype = "dashed") +
  labs(title = "Saturated Fatty Acids",
    x=expression(day~ of ~ the ~ year),
...
mufa_position_S_plot <- ggplot() +
  ...
  geom_vline(aes(xintercept = 137), linetype = "dashed") +
  geom_vline(aes(xintercept = 211), linetype = "dashed") +
  labs(title = "Monounsaturated Fatty Acids",
       x=expression(day~ of ~ the ~ year),
...
pufa_position_S_plot <- ggplot() +
  ...
  geom_vline(aes(xintercept = 137), linetype = "dashed") +
  geom_vline(aes(xintercept = 211), linetype = "dashed") +
  labs(title = "Polyunsaturated Fatty Acids",
       x=expression(day~ of ~ the ~ year),
...
fa_position_Diptera_S_plot <- ggplot() +
  ...
  labs(title = "Non-biting midges \n (Chironomidae, Diptera)",
       x=expression(day~ of ~ the ~ year),
       y=expression(FA ~"("~"µ"~g~ ~m^-2~d^-1~")")) +
  annotate(geom = "text", x = 105, y = 0.16, label = "spring", size = 6) +
  annotate(geom = "text", x = 175, y = 0.16, label = "summer", size = 6) +
  annotate(geom = "text", x = 240, y = 0.16, label = "autumn", size = 6) +
  ylim(-0.01, 0.16)
...
sfa_position_Diptera_S_plot <- ggplot() +
  ...
  labs(title = "Non-biting midges \n (Chironomidae, Diptera)", 
       x=expression(day~ of ~ the ~ year),
       y=expression(SFA ~"("~"µ"~g~ ~m^-2~d^-1~")")) +
  annotate(geom = "text", x = 105, y = 0.06, label = "spring", size = 6) +
  annotate(geom = "text", x = 175, y = 0.06, label = "summer", size = 6) +
  annotate(geom = "text", x = 240, y = 0.06, label = "autumn", size = 6) +
  ylim(-0.01, 0.06)
...
sfa_position_Trichoptera_S_plot <- ggplot() +
  theme_classic() + 
   theme(legend.title = element_blank(), legend.position="bottom", plot.title = element_blank(), legend.text = element_text(size=20), axis.text.x = element_blank(), axis.title.x = element_blank(), 
...
mufa_position_Trichoptera_S_plot <- ggplot() +
 ...
 = element_blank(), legend.text = element_text(size=20), axis.text.x = element_blank(), axis.title.x = element_blank(), 
        axis.text.y = element_blank(), axis.title.y = element_blank()) +
  guides(color = guide_legend(override.aes = list(size = 5))) +
...
mufa_position_Plecoptera_S_plot <- ggplot() +
  theme_classic() + 
   theme(legend.title = element_blank(), legend.position="bottom", plot.title = element_blank(), legend.text = element_text(size=20), axis.text.x = element_blank(), axis.title.x = element_blank(), axis.text.y = element_blank(), axis.title.y = element_blank()) +
  guides(color = guide_legend(override.aes = list(size = 5))) +
...
pufa_position_Diptera_S_plot <- ggplot() +
  ...
  labs(title = "Non-biting midges \n (Chironomidae, Diptera)", 
       x=expression(day~ of ~ the ~ year),
       y=expression(PUFA ~"("~"µ"~g~ ~m^-2~d^-1~")")) +
  annotate(geom = "text", x = 105, y = 0.10, label = "spring", size = 6) +
  annotate(geom = "text", x = 175, y = 0.10, label = "summer", size = 6) +
  annotate(geom = "text", x = 240, y = 0.10, label = "autumn", size = 6) +
  ylim(-0.01, 0.10)

pufa_position_Ephemeroptera_S_plot <- ggplot() +
  theme_classic() + 
     theme(legend.title = element_blank(), legend.position="bottom", plot.title = element_blank(), legend.text = element_text(size=20), 
           axis.text.x = element_text(size=15), axis.title.x = element_text(size=15), 
        axis.text.y = element_text(size=15), axis.title.y = element_text(size=15)) +
...
pufa_position_Trichoptera_S_plot <- ggplot() +
  theme_classic() + 
   theme(legend.title = element_blank(), legend.position="bottom", plot.title
 = element_blank(), legend.text = element_text(size=20), 
 axis.text.x = element_text(size=15), axis.title.x = element_text(size=15), 
        axis.text.y = element_blank(), axis.title.y = element_blank()) +
  guides(color = guide_legend(override.aes = list(size = 5))) +
...
pufa_position_Plecoptera_S_plot <- ggplot() +
  theme_classic() + 
   theme(legend.title = element_blank(), legend.position="bottom", plot.title = element_blank(), legend.text = element_text(size=20), axis.text.x = element_text(size = 15), axis.title.x = element_text(size = 15), axis.text.y = element_blank(), axis.title.y = element_blank()) +
  guides(color = guide_legend(override.aes = list(size = 5))) +
